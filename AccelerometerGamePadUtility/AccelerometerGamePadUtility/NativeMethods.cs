...
namespace AccelerometerGamePadUtility
{
    internal static class NativeMethods
    {
        ...
        internal static readonly IntPtr InvalidHandleValue = new IntPtr(INVALID_HANDLE_VALUE);
        ...
        [DllImport("kernel32.dll", CharSet = CharSet.Auto, SetLastError = true)]
        static internal extern IntPtr CreateFile(string lpFileName, uint dwDesiredAccess, int dwShareMode, IntPtr lpSecurityAttributes, int dwCreationDisposition, int dwFlagsAndAttributes, int hTemplateFile);
